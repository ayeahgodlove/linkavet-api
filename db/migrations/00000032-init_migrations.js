 ...
 * Actions summary:
 *
 * removeColumn "appointmentDateTime" from table "appointment"
 * removeColumn "vetDoctorId" from table "appointment"
 * removeColumn "petOwnerId" from table "appointment"
 * addColumn "symptoms" to table "appointment"
 * addColumn "contact" to table "appointment"
 * addColumn "email" to table "appointment"
 * addColumn "fullName" to table "appointment"
 * addColumn "appointmentTime" to table "appointment"
 * addColumn "appointmentDate" to table "appointment"
 * addColumn "doctorId" to table "appointment"
 * addColumn "userId" to table "appointment"
 *
 **/
...
const info = {
    ...
    "created": "2024-03-19T08:31:18.445Z",
    "comment": ""
};
...
const migrationCommands = [
    ...
    {
        fn: "removeColumn",
        params: ["appointment", "appointmentDateTime"]
    },
    {
        fn: "removeColumn",
        params: ["appointment", "vetDoctorId"]
    },
    {
        fn: "removeColumn",
        params: ["appointment", "petOwnerId"]
    },
    {
        fn: "addColumn",
        params: [
...
const rollbackCommands = [
    ...
    {
        fn: "removeColumn",
        params: ["appointment", "symptoms"]
    },
    {
        fn: "removeColumn",
        params: ["appointment", "contact"]
    },
    {
        fn: "removeColumn",
    ...
    {
        fn: "removeColumn",
        params: ["appointment", "fullName"]
    },
    {
        fn: "removeColumn",
        params: ["appointment", "appointmentTime"]
    },
    {
        fn: "removeColumn",
        params: ["appointment", "appointmentDate"]
    },
    {
        fn: "removeColumn",
