          ...
          <Row gutter={[16, 16]} align={"middle"} justify={"center"}>
                    ...
                    <Col xs={24} md={10}>
                      <div style={{ padding: 24 }}>
                        <Typography.Title
                          ...
                          style={{ color: "#02441c" }}
                        >
                          Welcome to LinkaVet.com - Your Trusted Partner in Pet
                          Care
                        </Typography.Title>
            ...
            <Col xs={22} style={{ margin: "20px 0" }}>
              ...
              <Typography.Paragraph>
                Join us on a journey to redefine pet care. Because at LinkaVet,
                we believe every pet deserves the best. This banner text aims to
                be welcoming and informative, highlighting the unique selling
                points of LinkaVet.com without overwhelming the reader with too
                much detail. The message focuses on the community aspect, the
          ...
          >
            <Col xs={22}>
              <Typography.Title
                ...
                style={{ textAlign: "center", marginTop: 30, color: "#02441c" }}
              >
                Our Journey to Excellence: Crafting the LinkaVet.com Experience
              </Typography.Title>
            </Col>
            <Col xs={22} md={8}>
              <Card hoverable bordered={false}>
                ...
                <Typography.Text>
                  The journey of LinkaVet.com began with a simple observation:
                  pet owners often navigate a fragmented landscape when seeking
                  products, advice, and healthcare for their pets. We envisioned
                  a unified platform that caters to all aspects of pet care - a
            ...
            <Col xs={22} md={8}>
              <Card hoverable bordered={false}>
                ...
                <Typography.Text>
                  ...
                  professionals, and pet owners themselves to gather insights
                  that would form the bedrock of our services.
                </Typography.Text>
              </Card>
            </Col>
            <Col xs={22} md={8}>
              <Card hoverable bordered={false}>
                ...
                <Typography.Text>
                  ...
                  comprehensive. Our e-commerce section offers a curated
                  selection of products, our courses platform provides access to
                  expert knowledge, and our vet consultation service ensures
            ...
            <Col xs={22} md={8}>
              <Card hoverable bordered={false}>
                ...
                <Typography.Text>
                  ...
                  our mission of promoting pet health, happiness, and
                  well-being.
                </Typography.Text>
              </Card>
            </Col>
            ...
            <Col xs={22} md={8}>
              <Card hoverable bordered={false}>
                ...
                <Typography.Text>
                  ...
                  learning and adapting ensures we remain at the forefront of
                  pet care innovation.
                </Typography.Text>
              </Card>
            </Col>
            ...
            <Col xs={22} md={8}>
              <Card hoverable bordered={false}>
                ...
                <Typography.Text>
                  ...
                  exploring new ways to expand our services, enhance our
                  platform, and deepen our impact on the lives of pets and their
                  owners. With every step, we remain dedicated to our founding
                  principle: to empower, engage, and elevate your pet care
                  experience.
                </Typography.Text>
              </Card>
            </Col>
