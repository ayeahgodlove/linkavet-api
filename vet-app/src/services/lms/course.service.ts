...
export const CourseService = {
    ...
    create: (course: ICourse): Promise<ICourseResponse> => requestType.post(`/api/courses`, course),
    update: (course: ICourse): Promise<ICourseResponse> => requestType.put(`/api/courses/${course.id}`, course),
