...
processPaymentRouter.post("/", process_payment_controller_1.initiatePayment);
processPaymentRouter.get("/:reference", process_payment_controller_1.transactionStatus);
